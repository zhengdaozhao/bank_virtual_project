...
export default function ButtonZpd({handleCancelClick,zpddyz,htmlType,marginLeft,colorZpd}){
    return(
        <Space>
        <ConfigProvider
          theme={{
        ...
        >
          <Button style={{width:'12rem',marginBottom:'1rem',marginLeft:marginLeft }} 
